...
function AddPartenatiat({
    ...
    return (
        <ScrollArea className="flex flex-col h-screen justify-center items-center bg-gradient-to-bl from-blue-50 via-cyan-300 to-blue-400">
            <div className="grid grid-rows-1 bg-white rounded-2xl p-20 text-gray-600">
                <div className="row-span-1">
                    <p className="text-2xl text-center">
                        Ajouter un partenariat
                    </p>
                    <p className="p-0.5 bg-gray-700 mt-1.5"></p>
                </div>
