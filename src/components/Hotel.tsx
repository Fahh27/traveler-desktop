...
function Hotel() {
    ...
    return (
        <>
            ...
            <button
                className="col-span-3 bg-gradient-to-r from-blue-500 to-cyan-500 hover:bg-blue-700 hover:text-gray-200 transition-colors duration-300 text-white px-4 py-2 rounded-xl mt-3"
                onClick={() => {
                    setCount(count + 1);
                    addChambre();
                }}
